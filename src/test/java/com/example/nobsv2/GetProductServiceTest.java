...
public class GetProductServiceTest {
    ...
    @Mock //what to mock the response of -> need this dependency to run
    private ProductRepository productRepository;

    @InjectMocks //the thing we are testing
    private GetProductService getProductService;

    @BeforeEach //things we need before the test runs
    public void setup() {
    ...
    public void given_product_exists_when_get_product_service_return_product_dto() {
        ...
        //still setting up even though it says "when"
    ...
    @Test
    public void given_product_does_not_exist_when_get_product_service_throws_product_not_found_exception() {
        //Given
